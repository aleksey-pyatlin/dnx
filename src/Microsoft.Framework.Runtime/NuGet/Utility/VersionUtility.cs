...
namespace NuGet
{
    public static class VersionUtility
    {
        ...
        internal const string CoreName = "core";
        internal const string Core50Name = CoreName + "50";
        ...
        public static FrameworkName ParseFrameworkName(string frameworkName)
        {
            ...
            // It's a little gross, but for now let's special case core50
            if (String.Equals(Core50Name, frameworkName, StringComparison.OrdinalIgnoreCase))
            {
